...
# TODO 1: Account holder names are not being printed correctly in Section 1. DONE
# TODO 2: Balances are not updating correctly after deposits in Section 3. DONE
# TODO 3: Withdrawals allow the balance to go negative in Section 2. 
# TODO 4: The greeting method is not displaying anything in Section 1. DONE
